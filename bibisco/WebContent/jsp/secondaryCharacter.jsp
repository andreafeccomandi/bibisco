...
//<![CDATA[
    ...
    function bibiscoSecondaryCharacterInitCallback(ajaxDialog, idCaller, type, id, config) {
		...
		bibiscoRichTextEditor = bibiscoRichTextEditorInit({text: secondaryCharacter.description, height: bibiscoRichTextEditorHeight+'px', width: jsBibiscoRichTextEditorWidth+'px'});
