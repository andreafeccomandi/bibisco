...
//<![CDATA[
    ...
    function formatRevisionActionSelectOption(state) {
        ...
        if ($(originalOption).attr('data-revisionOptionType') == 'action') {
            return '<span class="bibiscoSceneSelectRevisionOriginalOption">'+state.text+'</span>';
        } else {
            return state.text;
        }
    }
    ...
    <div class="accordion" id="sceneAccordion">
        <div class="accordion-group">
            <div class="accordion-heading">
                <span class="label label-info accordion-toggle" data-toggle="collapse" data-parent="#sceneAccordion" href="#sceneAccordionGroupPointOfView"> <fmt:message key="jsp.scene.pointOfView.title" />
                </span>
            </div>
            <div id="sceneAccordionGroupPointOfView" class="accordion-body collapse in">
                <div class="accordion-inner">
                    ...
                    <div class="row-fluid">
                        <button id="bibiscoSceneBtnPointOfView1stOnMajor" class="btn btnSceneTags scenePointOfView scenePointOfViewOnCharacter" data-toggle="button" data-id="FIRST_ON_MAJOR">
                            <fmt:message key="jsp.scene.button.pointOfView.1stOnMajor" />
                        </button>
                        <button id="bibiscoSceneBtnPointOfView1stOnMinor" class="btn btnSceneTags scenePointOfView scenePointOfViewOnCharacter" data-toggle="button" data-id="FIRST_ON_MINOR">
                            <fmt:message key="jsp.scene.button.pointOfView.1stOnMinor" />
                        </button>
                        <button id="bibiscoSceneBtnPointOfView3rdLimited" class="btn btnSceneTags scenePointOfView scenePointOfViewOnCharacter"data-toggle="button" data-id="THIRD_LIMITED">
                            <fmt:message key="jsp.scene.button.pointOfView.3rdLimited" />
                        </button>
                        <button id="bibiscoSceneBtnPointOfView3rdOmniscient" class="btn btnSceneTags scenePointOfView" data-toggle="button" data-id="THIRD_OMNISCIENT">
                            <fmt:message key="jsp.scene.button.pointOfView.3rdOmniscient" />
                        </button>
                        <button id="bibiscoSceneBtnPointOfView3rdObjective" class="btn btnSceneTags scenePointOfView" data-toggle="button" data-id="THIRD_OBJECTIVE">
                            <fmt:message key="jsp.scene.button.pointOfView.3rdObjective" />
                        </button>
                        <button id="bibiscoSceneBtnPointOfView2nd" class="btn btnSceneTags scenePointOfView" data-toggle="button" data-id="SECOND">
                            <fmt:message key="jsp.scene.button.pointOfView.2nd" />
                        </button>
                    </div>
                    <div class="row-fluid" id="bibiscoSceneDivScenePointOfViewCharacter">
                        <div class="row-fluid bibiscoSceneTagsExplains bibiscoSceneTagsExplainsPointOfViewCharacter"><fmt:message key="jsp.scene.label.pointOfView.character" /></div>
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                <span class="label label-info accordion-toggle" data-toggle="collapse" data-parent="#sceneAccordion" href="#sceneAccordionGroupCharacters"> <fmt:message key="jsp.scene.characters.title" /> </span>
            </div>
            <div id="sceneAccordionGroupCharacters" class="accordion-body collapse">
                <div class="accordion-inner">
                    ...
                    <c:forEach items="${characters}" var="character" varStatus="characterNumber">
                        <button class="btn btnSceneTags sceneCharacter" data-toggle="button" data-id="${character.idCharacter}">${character.name}</button>
                    </c:forEach>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <span class="label label-info accordion-toggle" data-toggle="collapse" data-parent="#sceneAccordion" href="#sceneAccordionGroupLocation"> <fmt:message key="jsp.scene.location.title" /> </span>
            </div>
            <div id="sceneAccordionGroupLocation" class="accordion-body collapse">
                <div class="accordion-inner">
                    ...
                    <c:forEach items="${locations}" var="location" varStatus="locationNumber">
                        <button class="btn btnSceneTags location" data-toggle="button" data-id="${location.idLocation}">${location.name}</button>
                    </c:forEach>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <span class="label label-info accordion-toggle" data-toggle="collapse" data-parent="#sceneAccordion" href="#sceneAccordionGroupTime"> <fmt:message key="jsp.scene.time.title" /> </span>
            </div>
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                <span class="label label-info accordion-toggle" data-toggle="collapse" data-parent="#sceneAccordion" href="#sceneAccordionGroupStrands"> <fmt:message key="jsp.scene.strands.title" /> </span>
            </div>
            <div id="sceneAccordionGroupStrands" class="accordion-body collapse">
                <div class="accordion-inner">
                    ...
                    <c:forEach items="${strands}" var="strand" varStatus="strandNumber">
                        <button class="btn btnSceneTags strand" data-toggle="button" data-id="${strand.idStrand}">${strand.name}</butmeton>
                    </c:forEach>
                </div>
            </div>
        </div>
...
<div class="bibiscoDialogFooter control-group bibiscoSceneCommands">
    <table>
        <tr>
            <td class="pagination-left"><tags:bibiscoTaskStatusSelector/></td>
            <td class="pagination-right">
                ...
                <select data-totalRevisions="" data-actualRevision="" class="selectpicker bibiscoSceneSelectRevision" id="bibiscoSceneSelectRevision"></select>            
                <a id="bibiscoSceneATextEditor" title="<fmt:message key="jsp.scene.button.showTextScene" />" class="btn" href="#"><i class="icon-edit"></i></a> 
                <a id="bibiscoSceneATags" title="<fmt:message key="jsp.scene.button.tags" />" class="btn" href="#"><i class="icon-tags"></i></a> 
                <a id="bibiscoSceneASave" title="<fmt:message key="jsp.common.button.save" />" class="btn btn-primary" href="#"><i class="icon-ok icon-white"></i></a> 
                <a id="bibiscoSceneAClose" title="<fmt:message key="jsp.common.button.close" />" class="btn ajaxDialogCloseBtn" href="#"><i class="icon-remove"></i></a>
            </td>
        </tr>
    </table>
</div>