...
angular.module('bibiscoApp').service('ArchitectureService', function(
  CollectionUtilService, LoggerService, ProjectDbConnectionService, ProjectService, UuidService
) {
  'use strict';
  ...
  return {
    ...
    updateWithoutCommit: function(architectureItem) {
      CollectionUtilService.updateWithoutCommit(this.getCollection(), architectureItem);
    }
  };
});
